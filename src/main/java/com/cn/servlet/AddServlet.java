...
@WebServlet(name = "AddServlet", urlPatterns = "/AddServlet", initParams = {@WebInitParam(name = "actionconfig", value = "action.properties")})
public class AddServlet extends HttpServlet {
    ...
    public void init(ServletConfig config) throws ServletException {
        ...
        is = AddServlet.class.getClassLoader().getResourceAsStream(properFile);
