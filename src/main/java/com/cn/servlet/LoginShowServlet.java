...
@WebServlet(name = "LoginShowServlet", urlPatterns = "/LoginShowServlet", initParams = {@WebInitParam(name = "actionconfig", value = "action.properties")})
...
public class LoginShowServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (actionName == null) {
            ...
            try {
                viewPath = action.execute("zc", request, response);
    ...
    public void init(ServletConfig config) throws ServletException {
        ...
        is = LoginShowServlet.class.getClassLoader().getResourceAsStream(properFile);
