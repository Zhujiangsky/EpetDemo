...
@WebServlet(name = "ShowServlet", urlPatterns = "/ShowServlet", initParams = {@WebInitParam(name = "actionconfig", value = "action.properties")})
public class ShowServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (actionName == null) {
            ...
            try {
                viewPath = action.execute("zhujiemian", request, response);
